...
# هو مقياس رياضي بيحدد العلاقة بين متغيرين 
# يعني: هل في علاقة بينهم؟ ولو في، هل العلاقة موجبة ولا سالبة، وهل هي قوية ولا ضعيفة.

#  أنواع الارتباط:

# ارتباط موجب (+)

# لو واحد زاد، التاني كمان بيزيد.

# مثال: عدد الساعات اللي بتذاكرها ↔ درجتك في الامتحان.

# ارتباط سالب (−)

# لو واحد زاد، التاني بيقل.

# مثال: عدد ساعات النوم المتأخرة بالليل ↔ مستوى النشاط الصبح.
...
# Table['column1'].corr(Table['column1'])
